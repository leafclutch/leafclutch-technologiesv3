  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        highlight:
          "bg-highlight text-highlight-foreground shadow-md hover:shadow-lg hover:-translate-y-0.5 font-bold",
        hero:
          "bg-highlight text-primary shadow-lg hover:shadow-xl hover:-translate-y-1 font-bold border-2 border-highlight/50",
        "hero-outline":
        ...
        gradient:
          "gradient-bg text-primary-foreground shadow-lg hover:shadow-xl hover:-translate-y-0.5",
      },
      size: {
